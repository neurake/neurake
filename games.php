...
<Header>
       ...
       <li><a href="games.php" id="gameshide" class="active">Games</a></li>
       </ul>
       </nav> 
</Header>
...
<Main>
    ...
    <div class="box-container">
        ...
        <div class="box">
            <img src="games/tic tac toe/tic tac toe.png" alt="">
            <h3>Tic Tac Toe</h3>
           
            <a href="games/tictactoe/tictactoeplay.php" class="btn">Play</a>
        </div>

        <div class="box">
            <img src="games/snake game 1/snake game 1.png" alt="">
            <h3>Snake Game 1</h3>
